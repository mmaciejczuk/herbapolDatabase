<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="HLOB2.Views.WydzialAdiustacji.Zlecenia.WebForm1" %>
        ...
        <tr>
            <td class="style6">
                ...
                <asp:DropDownList ID="DropDownListPolprodukty" runat="server" Width="435px" BackColor="#FFFFCC" 
                    ...
                    DataValueField="polproduktId" style="margin-top: 0px">
                </asp:DropDownList>
                ...
                <asp:DropDownList ID="DropDownListStatus" runat="server" BackColor="#FFFFCC" 
                    ...
                    <asp:Button ID="ButtonWyczysc" runat="server" 
                        Text="Usuń filtr" />
        ...
        <tr>
            <td class="style5">
             <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" 
                    DataKeyNames="zlecenieId" DataSourceID="AccessDataSourceZlecenia" AllowPaging="True" 
                    AllowSorting="True" CellPadding="1" ShowFooter="True"
                    ForeColor="#333333" PageSize="28" 
                    RowStyle-Height="10px"
                    BorderColor="#0066CC" BorderStyle="Solid" 
                    Font-Size="12px" BorderWidth="1px" onprerender="GridView1_PreRender1" >
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Indeks" SortExpression="indeks" ItemStyle-HorizontalAlign="Center"
                            ...
                            <EditItemTemplate>
                                <asp:Label Width="65px" Font-Size="12px" ID="LabelIndeks2" runat="server" Text=""></asp:Label>
                            </EditItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Półprodukt" SortExpression="polprodukt" 
                            ...
                            <FooterTemplate>
                                <asp:DropDownList Width="365px" ID="DropDownListPolprodukt" runat="server" DataSourceID="AccessDataSourcePolprodukty2"
                                DataTextField="nazwa" DataValueField="polproduktId" BackColor="#FFFFCC" Font-Size="12px" 
                                AutoPostBack="True" />
                            </FooterTemplate>
                            <EditItemTemplate>
                                <asp:DropDownList Width="365px" ID="DropDownListPolprodukt2" DataSourceID="AccessDataSourcePolprodukty2" runat="server" 
                                DataTextField="nazwa" DataValueField="polproduktId" BackColor="#FFFFCC" Font-Size="12px"
                                AutoPostBack="True" />
                            </EditItemTemplate>
                        </asp:TemplateField>
