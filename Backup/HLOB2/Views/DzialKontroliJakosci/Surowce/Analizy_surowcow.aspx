...
<%--              <asp:UpdatePanel ID="UpdatePanel1" runat="server">  
                  <ContentTemplate>--%>
                        <asp:DropDownList ID="DropDownListAliasy" runat="server" BackColor="White" 
                            ...
                            onselectedindexchanged="DropDownListAliasy_SelectedIndexChanged">
                        </asp:DropDownList>
...
<%--                    </ContentTemplate>
            ...
            <td class="style17">
                       <span class="style19">Typ analizy: </span>&nbsp;<asp:DropDownList 
                           ...
                           AutoPostBack="True" 
                           onselectedindexchanged="DropDownListRodzajeAnaliz_SelectedIndexChanged">
                       </asp:DropDownList>
            </td>
            <td class="style5">
                        &nbsp;&nbsp;
...
<%--                        <asp:TemplateField>
        ...
        <asp:AccessDataSource ID="AnalizySurowcowAccessDataSource" runat="server" 
            ...
            <SelectParameters>
                <asp:ControlParameter Name="aliasId" ControlID="DropDownListAliasy"
        ...
        <asp:AccessDataSource ID="FiltrAccessDataSource" runat="server" 
            ...
            sa.dataWykonania FROM RodzajeAnaliz ra, SurowceAnalizy sa, Oddzialy o WHERE
            sa.rodzaj = ra.analizaId AND sa.oddzial = o.oddzialId
            AND aliasId=? AND rodzaj LIKE ? ORDER BY sa.dataDodania DESC"
            DeleteCommand="DELETE FROM [SurowceAnalizy] WHERE [id] = ?" >
            <DeleteParameters>
                <asp:Parameter Name="id" Type="Int32" />
            </DeleteParameters>
            <SelectParameters>
                <asp:ControlParameter Name="aliasId" ControlID="DropDownListAliasy"
                PropertyName="SelectedValue" />
                <asp:ControlParameter Name="rodzaj" ControlID="DropDownListRodzajeAnaliz"
                PropertyName="SelectedValue" />
            </SelectParameters>
        </asp:AccessDataSource>
