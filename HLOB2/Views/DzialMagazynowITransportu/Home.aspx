<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DzialMagazynowITransportu.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="HLOB2.Views.DzialMagazynowITransportu.Startowa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <table class="style1">
        ...
        <tr>
            <td>
                &nbsp; <span class="style3">&nbsp;</span><span class="style2"><strong>Aktualności:</strong></span></td>
        </tr>
        <tr>
            <td>
                &nbsp;</td>
        ...
        <tr>
            <td>
                ...
                <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT tresc, dataDodania FROM Aktualności WHERE dzial=2">
