<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/User.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="HLOB2.Views.User.Home" %>
        ...
        <tr>
            <td>
                ...
                <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT tresc, dataDodania FROM Aktualności WHERE dzial=6">
