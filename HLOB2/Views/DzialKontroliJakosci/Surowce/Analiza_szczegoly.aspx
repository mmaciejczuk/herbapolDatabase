<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DzialKontroliJakosci.Master" AutoEventWireup="true" CodeBehind="Analiza_szczegoly.aspx.cs" Inherits="HLOB2.Views.DzialKontroliJakosci.Surowce.Analiza_szczegoly" %>
        ...
        <script type="text/javascript" language="javascript">
            function checkbox_Checked(checkBox) {
                if (document.getElementById(checkBox).checked) {
                    ...
                    var e = document.getElementById('<%=LabelNrSpecyfikacji.ClientID%>');
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="style1">
        <tr>
            <td>
                <strong>ANALIZA SUROWCA - SZCZEGÓŁY</strong></td>
        </tr>
        <tr>
            <td>
                <hr /></td>
    ...
    <table>
            ...
            <td class="style41">
                ...
                <asp:Label ID="LabelSurowiec" runat="server" 
                    style="font-weight: 700; font-size: medium; color: #333300; "></asp:Label>
            ...
            <td class="style41">
                ...
                <asp:Label ID="LabelRodzajAnalizy" runat="server" 
                    style="color: #996633; font-weight: 700; "></asp:Label>
&nbsp;<strong>/</strong> specyfikacja nr
                <asp:Label ID="LabelNrSpecyfikacji" runat="server" 
                    style="font-weight: 700; color: #996633; "></asp:Label>
          ...
          <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
               ...
               <asp:ListView ID="ListViewNaglowek" runat="server" DataKeyNames="numerAnalizy" 
                    ...
                    DataSourceID="AccessDataSourceNaglowek" 
                    onitemdatabound="ListViewNaglowek_ItemDataBound" 
                    >
                <ItemTemplate>
                    <tr style="background-color:#DCDCDC;color: #000000;">
                        <td style="text-align:center; height:30px" >
                            <asp:TextBox ID="numerAnalizyLabel" runat="server" Width="100" ReadOnly="True" />
                        </td>
                        <td style="text-align:right; height:30px" >
                            <asp:DropDownList ID="DropDownListOddzial" runat="server" 
                            DataSourceID="AccessDataSourceOddzialy" DataTextField="nazwa" 
                            DataValueField="oddzialId" Width="140" >
                            </asp:DropDownList>
                        </td>
                        <td style="text-align:right; height:30px" >
                            <asp:DropDownList ID="DropDownListPunktSkupu" runat="server" Width="155"
                            DataSourceID="AccessDataSourcePunktySkupu" DataTextField="nazwa"
                            DataValueField="punktId" >
                            </asp:DropDownList>
                        </td>
                        <td style="text-align:right; height:30px" >
                            <asp:TextBox runat="server" ID="TextBoxDostawca" Width="130" MaxLength="45" />
                        </td>
                        <td style="text-align:right; height:30px" >
                            <asp:TextBox runat="server" ID="TextBoxWaga" Width="60" MaxLength="8" />
                        ...
                        <td style="text-align:right; height:30px" >
                            ...
                            DataSourceID="AccessDataSourcePobral" Width="165" 
        ...
        <tr>
            <td class="style3">
                <asp:DetailsView ID="DetailsViewSpecyfikacja" runat="server" Height="50px" Width="445px" 
                    ...
                    FieldHeaderStyle-Width="80px" Enabled="False" >
    ...
    <table class="style1">
        ...
        <ContentTemplate>
            <asp:ListView ID="ListViewPodsumowanie" runat="server" 
                ...
                onitemdatabound="ListViewPodsumowanie_ItemDataBound" Enabled="False">
                <ItemTemplate>
                    <tr style="background-color:#DCDCDC;color: #000000;">
