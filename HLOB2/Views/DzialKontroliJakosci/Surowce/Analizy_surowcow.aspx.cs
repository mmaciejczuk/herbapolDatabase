    ...
    public partial class Analizy_surowcow : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (DropDownListAliasy.SelectedValue == "-1")
                {
                    GridViewAnalizy.DataSourceID = "AnalizySurowcowAccessDataSourceNone";
        ...
        {
/*            if (DropDownListRodzajeAnaliz.SelectedValue == "9" || DropDownListRodzajeAnaliz.SelectedValue == "-1")
            {
                GridViewAnalizy.DataSourceID = "AnalizySurowcowAccessDataSource";
                GridViewAnalizy.DataBind();
            }
            else if (DropDownListRodzajeAnaliz.SelectedValue != "9" || DropDownListRodzajeAnaliz.SelectedValue != "-1")
            {
